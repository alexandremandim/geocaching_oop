   ...
   private static boolean login(UsersGroup utilizadores){
    ...
    private static boolean createCache(TreeSet <Cache> caches){
        ...
        while(erro==1){
            ...
            if(dificuldade <1 || dificuldade >10) erro = 1;
        }
        ...
        novaCache = new Cache(latitude,longitude,informacoesAux,nome,dificuldade);
        return(caches.add(novaCache));
    }
        ...
        while(escolha != 0){
            ...
            switch(escolha){
                ...
                case 6:
                    ...
                    if(ano < 1800 || mes < 1 || mes > 12 || dia < 1 || dia > 31) {
    ...
    private static void testes(UsersGroup users, TreeSet <Cache> treeCaches){
        ...
        novaCache = new Cache(2,2, "nada a declarar", "cacheTeste", 3);
        treeCaches.add(novaCache);
        novaCache = new Cache(1,5, "nada a declarar", "cacheTeste2", 7);
        treeCaches.add(novaCache);
        novaCache = new Cache(2,9, "nada a declarar", "cacheTeste3", 2);
        treeCaches.add(novaCache);
    ...
    public static void main (String args[]){
        ...
        if(isLogged == true){
            ...
            /* Menu User */
           while(choice != 0){
               System.out.println("1. Criar uma cache;" +"\n"+ "2. Invalidar uma cache;" +"\n"+"3. Registar descoberta de uma cache (Simular condições meteorológicas);" 
               ...
               "10. Ver estatística mensalmente ou anualmente (Diferentes tipos de cache);" +"\n" + "0. Sair;");
